	...
	cartObj.cart.add=function(id,image,name,price,qty){
		if( cartObj.cart.find(id)!=-1 ){
			var alertPopup = $ionicPopup.alert({
                title: 'السيارة مضافة فعلا ',
                template: 'عذرا السيارة مضافة فعلا'
            });
...
.factory('sharedFilterService', [function(){
	...
	var obj = {};
    obj.str = "http://192.168.43.228/carAPI/car_menu.php?till=";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	obj.till=0;
	...
	obj.getUrl=function(){
		...
		obj.till=obj.till + 5;
		obj.str="http://192.168.43.228/carAPI/car_menu.php?till="+obj.till; // pass the value to url
